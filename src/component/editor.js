...
function inputEventHandler(evt) {
  ...
  if(v.startsWith('$')){
    this.formulas = deepClone(this.hint);
    resetSuggestItems.call(this);
  }else if(v.startsWith('=')){
    this.formulas =deepClone(formulas);
    resetSuggestItems.call(this);
  }
...
export default class Editor {
  constructor(hint, viewFn, rowHeight) {
    this.hint = hint;
    this.viewFn = viewFn;
    this.rowHeight = rowHeight;
    this.formulas = this.inputText?.startsWith('$') ? deepClone(hint) : deepClone(formulas);
    if(hint&&this.inputText?.startsWith('$')){
      this.suggest = new Suggest(hint, (it) => {
        this.suggestItemClick.call(this, it);
      });
    }else{
